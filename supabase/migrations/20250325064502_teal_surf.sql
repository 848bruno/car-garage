...
BEGIN
  ...
  VALUES 
    (gen_random_uuid(), 'Oil Change Service', 'Full synthetic oil change with filter replacement', 79.99, 45),
    (gen_random_uuid(), 'Brake Service', 'Brake pad replacement and rotor inspection', 249.99, 120),
    (gen_random_uuid(), 'Tire Rotation', 'Tire rotation and balance', 49.99, 45),
    (gen_random_uuid(), 'Engine Diagnostic', 'Complete engine diagnostic scan', 89.99, 60),
    (gen_random_uuid(), 'AC Service', 'AC system check and recharge', 129.99, 90)
