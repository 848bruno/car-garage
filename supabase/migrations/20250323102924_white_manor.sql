...
VALUES 
  ('oil-change', 'Oil Change Service', 'Full synthetic oil change with filter replacement', 79.99, 45),
  ('brake-service', 'Brake Service', 'Brake pad replacement and rotor inspection', 249.99, 120),
  ('tire-rotation', 'Tire Rotation', 'Tire rotation and balance', 49.99, 45),
  ('engine-diagnostic', 'Engine Diagnostic', 'Complete engine diagnostic scan', 89.99, 60),
  ('ac-service', 'AC Service', 'AC system check and recharge', 129.99, 90)
